      ...
      <div className="about-us">
        ...
        <div className="about-us__why-healthCare">
          ...
          <p>
            ...
            cost-effective healthcare solutions. Our app simplifies the process
            of finding and booking appointments with qualified doctors, making
        ...
        <div className="about-us__our-culture">
          <h2>Our Culture</h2>
          <p>
            Each patient and practitioner is important at doctoranytime.be. We
            are honoured and thrilled by their complete trust in us and
            willingness do everything to keep it.
          </p>
          <p>
          ...
          <p>
            Everyone at doctoranytime.be is a valuable addition to our young
            team. We love our fun and intimate working atmosphere in which each
            member can realise their full potential.
          </p>
        </div>
        <div className="about-us__expertise">
          ...
          <p>
            ...
            best medical experience, we see it is as our duty to deliver
        ...
        <div className="about-us__team">
          ...
          <p>
            ...
            passionate about improving patient care. We are dedicated to
            providing the best healthcare services to our patients.
          </p>
        </div>
      </div>
    </>
